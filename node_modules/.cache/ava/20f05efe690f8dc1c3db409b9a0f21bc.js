...
(0, _ava2.default)('it should determine whether a string conatins another string', function (t) {
	...
	t.false(_rec3._expr(_rec3._capt(_rec3._capt((0, _src.str)('foobarbaz'), 'arguments/0/callee/object').contains('baz', 2), 'arguments/0'), {
		content: 't.false(str(\'foobarbaz\').contains(\'baz\', 2))',
		filepath: 'test/Str.js',
		line: 22,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"Identifier","name":"str","range":[8,11]},"arguments":[{"type":"StringLiteral","value":"foobarbaz","range":[12,23]}],"range":[8,24]},"property":{"type":"Identifier","name":"contains","range":[25,33]},"computed":false,"range":[8,33]},"arguments":[{"type":"StringLiteral","value":"baz","range":[34,39]},{"type":"NumericLiteral","value":2,"range":[41,42]}],"range":[8,43]}],"range":[0,44]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"str","range":[8,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"string"},"value":"foobarbaz","range":[12,23]},{"type":{"label":")"},"range":[23,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"contains","range":[25,33]},{"type":{"label":"("},"range":[33,34]},{"type":{"label":"string"},"value":"baz","range":[34,39]},{"type":{"label":","},"range":[39,40]},{"type":{"label":"num"},"value":2,"range":[41,42]},{"type":{"label":")"},"range":[42,43]},{"type":{"label":")"},"range":[43,44]}]',
		visitorKeys: _powerAssertVisitorKeys
	}));
});
//# sourceMappingURL=../node_modules/.cache/ava/20f05efe690f8dc1c3db409b9a0f21bc.js.map