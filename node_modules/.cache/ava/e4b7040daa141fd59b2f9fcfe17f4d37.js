...
(0, _ava2.default)('it should check if a string ends with a string', function (t) {
  ...
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(Str, 'arguments/0/callee/object').endsWith('Lorem ipsum dolor sit amet', 'amet'), 'arguments/0'), {
    content: 't.true(Str.endsWith(\'Lorem ipsum dolor sit amet\', \'amet\'))',
    filepath: 'test/Str.js',
    line: 44,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Str","range":[7,10]},"property":{"type":"Identifier","name":"endsWith","range":[11,19]},"computed":false,"range":[7,19]},"arguments":[{"type":"StringLiteral","value":"Lorem ipsum dolor sit amet","range":[20,48]},{"type":"StringLiteral","value":"amet","range":[50,56]}],"range":[7,57]}],"range":[0,58]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"Str","range":[7,10]},{"type":{"label":"."},"range":[10,11]},{"type":{"label":"name"},"value":"endsWith","range":[11,19]},{"type":{"label":"("},"range":[19,20]},{"type":{"label":"string"},"value":"Lorem ipsum dolor sit amet","range":[20,48]},{"type":{"label":","},"range":[48,49]},{"type":{"label":"string"},"value":"amet","range":[50,56]},{"type":{"label":")"},"range":[56,57]},{"type":{"label":")"},"range":[57,58]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
  t.false(_rec9._expr(_rec9._capt(_rec9._capt(Str, 'arguments/0/callee/object').endsWith('Lorem ipsum dolor sit amet', 'ipsum'), 'arguments/0'), {
    content: 't.false(Str.endsWith(\'Lorem ipsum dolor sit amet\', \'ipsum\'))',
    filepath: 'test/Str.js',
    line: 45,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Str","range":[8,11]},"property":{"type":"Identifier","name":"endsWith","range":[12,20]},"computed":false,"range":[8,20]},"arguments":[{"type":"StringLiteral","value":"Lorem ipsum dolor sit amet","range":[21,49]},{"type":"StringLiteral","value":"ipsum","range":[51,58]}],"range":[8,59]}],"range":[0,60]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"Str","range":[8,11]},{"type":{"label":"."},"range":[11,12]},{"type":{"label":"name"},"value":"endsWith","range":[12,20]},{"type":{"label":"("},"range":[20,21]},{"type":{"label":"string"},"value":"Lorem ipsum dolor sit amet","range":[21,49]},{"type":{"label":","},"range":[49,50]},{"type":{"label":"string"},"value":"ipsum","range":[51,58]},{"type":{"label":")"},"range":[58,59]},{"type":{"label":")"},"range":[59,60]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//
...
// });
//# sourceMappingURL=../node_modules/.cache/ava/e4b7040daa141fd59b2f9fcfe17f4d37.js.map