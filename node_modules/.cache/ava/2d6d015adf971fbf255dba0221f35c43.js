...
(0, _ava2.default)('it should generate a random string', function (t) {
	...
	t.true(_rec4._expr(_rec4._capt(_rec4._capt(type, 'arguments/0/callee/object').isString(_rec4._capt(_rec4._capt((0, _src.str)(), 'arguments/0/arguments/0/callee/object').random(), 'arguments/0/arguments/0')), 'arguments/0'), {
		content: 't.true(type.isString(str().random()))',
		filepath: 'test/Str.js',
		line: 32,
		ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"type","range":[7,11]},"property":{"type":"Identifier","name":"isString","range":[12,20]},"computed":false,"range":[7,20]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"Identifier","name":"str","range":[21,24]},"arguments":[],"range":[21,26]},"property":{"type":"Identifier","name":"random","range":[27,33]},"computed":false,"range":[21,33]},"arguments":[],"range":[21,35]}],"range":[7,36]}],"range":[0,37]}',
		tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"type","range":[7,11]},{"type":{"label":"."},"range":[11,12]},{"type":{"label":"name"},"value":"isString","range":[12,20]},{"type":{"label":"("},"range":[20,21]},{"type":{"label":"name"},"value":"str","range":[21,24]},{"type":{"label":"("},"range":[24,25]},{"type":{"label":")"},"range":[25,26]},{"type":{"label":"."},"range":[26,27]},{"type":{"label":"name"},"value":"random","range":[27,33]},{"type":{"label":"("},"range":[33,34]},{"type":{"label":")"},"range":[34,35]},{"type":{"label":")"},"range":[35,36]},{"type":{"label":")"},"range":[36,37]}]',
		visitorKeys: _powerAssertVisitorKeys
	}));
	t.is((0, _src.str)().random(16).length, 16);
	t.is((0, _src.str)().random().length, 32);
});
//# sourceMappingURL=../node_modules/.cache/ava/2d6d015adf971fbf255dba0221f35c43.js.map