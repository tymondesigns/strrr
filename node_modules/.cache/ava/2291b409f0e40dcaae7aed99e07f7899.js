...
(0, _ava2.default)('it should check if a string ends with a string', function (t) {
  ...
  t.true(_rec10._expr(_rec10._capt(_rec10._capt((0, _src.str)('Lorem ipsum dolor sit amet'), 'arguments/0/callee/object').endsWith('sit', 5), 'arguments/0'), {
    content: 't.true(str(\'Lorem ipsum dolor sit amet\').endsWith(\'sit\', 5))',
    filepath: 'test/Str.js',
    line: 46,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"Identifier","name":"str","range":[7,10]},"arguments":[{"type":"StringLiteral","value":"Lorem ipsum dolor sit amet","range":[11,39]}],"range":[7,40]},"property":{"type":"Identifier","name":"endsWith","range":[41,49]},"computed":false,"range":[7,49]},"arguments":[{"type":"StringLiteral","value":"sit","range":[50,55]},{"type":"NumericLiteral","value":5,"range":[57,58]}],"range":[7,59]}],"range":[0,60]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"str","range":[7,10]},{"type":{"label":"("},"range":[10,11]},{"type":{"label":"string"},"value":"Lorem ipsum dolor sit amet","range":[11,39]},{"type":{"label":")"},"range":[39,40]},{"type":{"label":"."},"range":[40,41]},{"type":{"label":"name"},"value":"endsWith","range":[41,49]},{"type":{"label":"("},"range":[49,50]},{"type":{"label":"string"},"value":"sit","range":[50,55]},{"type":{"label":","},"range":[55,56]},{"type":{"label":"num"},"value":5,"range":[57,58]},{"type":{"label":")"},"range":[58,59]},{"type":{"label":")"},"range":[59,60]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
...
// });
//# sourceMappingURL=../node_modules/.cache/ava/2291b409f0e40dcaae7aed99e07f7899.js.map